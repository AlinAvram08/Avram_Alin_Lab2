...
namespace Avram_Alin_Lab2.Migrations
{
    ...
    [Migration("20221217174154_Borrowings")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Avram_Alin_Lab2.Models.Book", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Avram_Alin_Lab2.Models.BookCategory", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Avram_Alin_Lab2.Models.Book", b =>
                {
                    b.HasOne("Avram_Alin_Lab2.Models.Author", "Author")
                        .WithMany("Books")
                        .HasForeignKey("AuthorID");

                    b.HasOne("Avram_Alin_Lab2.Models.Publisher", "Publisher")
                        .WithMany("Books")
            ...
            modelBuilder.Entity("Avram_Alin_Lab2.Models.BookCategory", b =>
                {
                    ...
                    b.HasOne("Avram_Alin_Lab2.Models.Category", "Category")
                        .WithMany("BookCategories")
